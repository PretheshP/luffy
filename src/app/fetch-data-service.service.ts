...
export class FetchDataServiceService {
  ...
  private _url = "https://localhost:44369/api/Account/getAccount/";
  getAccount(aid: string): Observable<Account> {

    return this.http.get<Account>(this._url + aid);
  }

  private _url2 = "https://localhost:44347/api/Transaction/getTransactions/";
  getTransData(cid: string): Observable<Transactions[]> {
    return this.http.get<Transactions[]>(this._url2 + cid);
  }

  private _url3 = "https://localhost:44369/api/Account/getAccountStatement";
  ...
  private _url4 = "https://localhost:44347/api/Transaction/deposit";
  ...
  private _url5 = "https://localhost:44347/api/Transaction/withdraw";
  ...
  private _url6 = "https://localhost:44347/api/Transaction/transfer";
...
// createCustomer(data: { customerId: string, name: string, address: string, dob: string, paNno: string }): Observable<CreateRes> {
//   console.log(this.http.post(this._url7, data, {
//     headers: {
//       'Content-Type': 'application/json; Charset=UTF-8'
//     }
//   }));
//   return this.http.post<CreateRes>(this._url7, data, {
//     headers: {
//       'Content-Type': 'application/json; Charset=UTF-8'
//     }
//   });
